...
<head>
    ...
    <style>
        ...
        body {
            ...
            background: linear-gradient(#ffffff, #4082c8);
        }
...
<body>
    ...
    <div class="login-box">
        ...
        <div class="alert alert-warning">
            <p style="text-align: center; color: white;">Responde a la pregunta</p>
        </div>
        <form class="user" method="POST" action="<?php echo base_url(); ?>/verificar">
            <div class="user-box">
